...
The script updates all known GitHub publicly available [Colour Maximite 2](https://github.com/MiSTer-devel/Main_MiSTer/wiki) software, including menu.rbf and the main MiSTer Linux executable; it updates scaler filters, GameBoy palettes and scripts; it can (experimental and risky) optionally update the whole Linux system.<br>
